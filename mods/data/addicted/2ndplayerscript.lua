...
idleoffsets = {'0', '-80'} -- I recommend you have your idle offset at 0
leftoffsets = {'66', '-60'}
downoffsets = {'41', '-140'}
upoffsets = {'15', '-16'}
rightoffsets = {'-12', '-30'}
...
idle_xml_name = 'garcello_idle'
left_xml_name = 'garcello_left'
down_xml_name = 'garcello_down'
up_xml_name = 'garcello_up'
right_xml_name = 'garcello_right'
...
name_of_character_xml = 'garcellossmokinass'
name_of_character = 'garcellossmokinass'
name_of_notetype = 'GarcelloNotes'
